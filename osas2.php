...
<body>
    ...
    <form action="" method="post"  enctype="multipart/form-data">
      ...
      <input type="submit" name="submit1" class="button button1" value="Upload">
            </div>
            </div>
            </form>
           <?php
      ...
      if(isset($_POST["submit1"])){
         ...
         $user_check_query = "INSERT INTO osas (image1, fname, mname, lname, position, year) VALUES ('$image', '$firstName', '$midName', '$lastName', '$course', '$year')";
         $result = mysqli_query($db, $user_check_query);
         echo "<script>alert('Added Successfully!');window.location='tab2.php';</script>";
      }
?>
</body>
</html>