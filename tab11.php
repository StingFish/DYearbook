...
<div id="mySidenav" class="sidenav">
  ...
  <a href="tab11.php" class="active">Milestones & activities</a>
...
<div class="row">
        ...
        <tbody>
          ...
          echo "<td style='width:200px;' align='center'>".'<img class="imahe" style="width:300px; height:200px;" src="data:image/jpeg;base64,'.base64_encode($row['image1'] ).'"/>'."</td>";
          echo "<td style='width:40px;' align='center'>" . $row['year'] . "</td>";
          echo "</tr>";
}
echo "</body>";
echo "</table>";
