...
<div id="mySidenav" class="sidenav">
  ...
  <a href="#">Message</a>
  <a href="tabs2.php" class="active">Administrative Officers</a>
...
<div class="row">
  ...
  <div class="search-container">
    <form>
<button type="submit" name="Adds" class="button1" style="float: left;margin-right: 470px;background-color:#0275d8;color:white;">Add Member</button>
...
window.addEventListener('keydown',function(e){if(e.keyIdentifier=='U+000A'||e.keyIdentifier=='Enter'||e.keyCode==13){if(e.target.nodeName=='INPUT'&&e.target.type=='text'){e.preventDefault();return false;}}},true);
        ...
        <tbody>
          ...
          echo "<td style='width:100px;' align='center'>
                ...
                <a class='delbtn' style='text-decoration:none; color:white;' href ='registarFunctions.php?edit2=".$row['id']."'>&#9998;&nbsp;EDIT</a>
                  </button><br><br>
                  <button class='button3' style='border:1px solid;border-color:red;width:90%'>
                <a class='delbtn' style='text-decoration:none; color:white;' href='registarFunctions.php?email2=".$row['fname']."'>&#128465;&nbsp;REMOVE</a>
                  </button>                
                  </td>";
          echo "</tr>";
}
